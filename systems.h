...
Matrix *backwards_substitution(Matrix *A, Matrix* b);   //solves a linear system where matrix A is upper triangular
...
Matrix *gaussian_elimination(Matrix *A, Matrix *b);     //solves the linear system overwriting matrix A using max pivot permutation
